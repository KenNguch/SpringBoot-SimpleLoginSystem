package github.kennguch.loginsystem.config;

import github.kennguch.loginsystem.filter.JwtAuthenticationFilter;
import github.kennguch.loginsystem.service.CustomUserDetailService;
...
public class JwtConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/api/login","/api/roles", "/api/register").permitAll()//only allow this endpoint without authentication
